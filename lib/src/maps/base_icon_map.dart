...
/// Includes only the base variants of the icons from the flutter material
/// icons library. Meaning, variants like, 'sharp', 'outlines', etc.
/// are not present.
const Map<String, IconData> baseIconMap = <String, IconData>{
  'ten_k': Icons.ten_k,
  'ten_mp': Icons.ten_mp,
